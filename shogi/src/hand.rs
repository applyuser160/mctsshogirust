...
pub struct Hand {
    pub pieces: [piece::Piece;
        (piece::NOT_PRO_PIECE_TYPE_NUMBER * color::ColorType::ColorNumber as u8)
            as usize],
    pub counts: [u8; (piece::NOT_PRO_PIECE_TYPE_NUMBER
        * color::ColorType::ColorNumber as u8) as usize],
}

impl Hand {
    #[allow(dead_code)]
    fn calc_index(color_type: color::ColorType, piece_type: piece::PieceType) -> u16 {
        return color_type as u16 * piece::NOT_PRO_PIECE_TYPE_NUMBER as u16
            + piece_type as u16
            - 1;
    }
    ...
    pub fn new() -> Self {
        let mut res = Self {
            pieces: [piece::Piece::new();
                (piece::NOT_PRO_PIECE_TYPE_NUMBER * color::ColorType::ColorNumber as u8)
                    as usize],
            counts: [0; (piece::NOT_PRO_PIECE_TYPE_NUMBER
                * color::ColorType::ColorNumber as u8)
                as usize],
        };
        for j in
            color::ColorType::Black as usize..color::ColorType::ColorNumber as usize
        {
            for i in piece::PieceType::King as usize
                ..=piece::NOT_PRO_PIECE_TYPE_NUMBER as usize
            {
    ...
    pub fn get_player_pieces(&self, color_type: color::ColorType) -> Vec<piece::Piece> {
        ...
        for i in
            piece::PieceType::King as usize..=piece::NOT_PRO_PIECE_TYPE_NUMBER as usize
        {
